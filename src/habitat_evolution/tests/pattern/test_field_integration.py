...
from habitat_evolution.core.field.gradient.controller import GradientFlowController, FieldGradients
from habitat_evolution.core.pattern import FieldDrivenPatternManager
...
class TestFieldIntegration:
    ...
    @pytest.fixture
    async def pattern_manager(self):
        ...
        return FieldDrivenPatternManager(pattern_store, relationship_store, event_bus)
