...
from src.habitat_evolution.pattern_aware_rag.services.mongo_service import MongoConfig, MongoClient
...
class ClimateRiskIntegrationTest(unittest.TestCase):
    ...
    def process_document_through_rag(self, document: Dict[str, Any]) -> tuple:
        ...
        for pattern_id, props in pattern_eigenspace_properties.items():
            ...
            if not hasattr(topology_state, "resonance_groups"):
                topology_state.resonance_groups = {}
