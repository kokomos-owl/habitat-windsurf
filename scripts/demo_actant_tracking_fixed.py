...
def create_sample_data():
    ...
    logger.info(f"Created document 1: {doc1_id}")
    ...
    logger.info(f"Created document 2: {doc2_id}")
    ...
    logger.info(f"Created domain 1.1: {domain1_1_id}")
    ...
    logger.info(f"Created domain 1.2: {domain1_2_id}")
    ...
    logger.info(f"Created domain 1.3: {domain1_3_id}")
    ...
    logger.info(f"Created domain 2.1: {domain2_1_id}")
    ...
    logger.info(f"Created domain 2.2: {domain2_2_id}")
    
    # Create actants
    coral_actant = actant_repo.find_or_create("coral", ["coral reefs", "coral species", "coral polyps", "coral hosts"])
    logger.info(f"Created/found coral actant: {coral_actant.id}")
    
    algae_actant = actant_repo.find_or_create("symbiotic algae", ["algae"])
    logger.info(f"Created/found algae actant: {algae_actant.id}")
    ...
    logger.info(f"Created/found temperature actant: {temperature_actant.id}")
    
    scientists_actant = actant_repo.find_or_create("scientists")
    logger.info(f"Created/found scientists actant: {scientists_actant.id}")
    ...
    logger.info(f"Created predicate 1.1: {pred1_1_id}")
    ...
    logger.info(f"Created predicate 1.2: {pred1_2_id}")
    ...
    logger.info(f"Created predicate 1.3: {pred1_3_id}")
    ...
    logger.info(f"Created predicate 2.1: {pred2_1_id}")
    ...
    logger.info(f"Created predicate 2.2: {pred2_2_id}")
    ...
    logger.info(f"Created predicate 2.3: {pred2_3_id}")
...
def track_actant_evolution(actant_name: str):
    ...
    logger.info(f"Tracking evolution of actant: {actant_name}")
...
def find_resonating_domains():
    ...
    logger.info("Finding resonating domains...")
